...
public class DirectedGraph<V extends Identifiable, E> {
    ...
    public boolean addEdge(V fromVertex, V toVertex, E newEdge) {
        ...
        Set<E> neighbours1 = (Set<E>) this.edges.get(fromVertex);
        Set<E> neighbours2 = (Set<E>) this.edges.get(toVertex);

        if (neighbours1 == null || neighbours2 == null){
            return false;
        }
        return neighbours1.add(newEdge) && neighbours2.add(newEdge);
    }
